...
Partial Class Admin_NAdmin_Admins_AddAdmin
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            getData("select * from OtherAdminLogins order by Branch ")
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles BtnSave.Click
        ...
        If BtnSave.Text = "Update" Then
            ...
            Else
                ...
                DsAdmins.Update(TxtLoginId.Text, LblPassword.Text, TxtName.Text, 0, Permissions, TxtEmailId.Text, LblActiveStatus.Text, LblOtherAdminID.Text)
        ...
        Else
            ...
            Else
                ...
                DsAdmins.Insert(TxtLoginId.Text, Password, TxtName.Text, 0, Permissions, TxtEmailId.Text, "Y")
                ...
                If TxtEmailId.Text <> "" Then
                    Message = "<font face='Verdana' size='2'>Dear " & TxtName.Text & ", <br /><br />" & _
                            ...
                            "<br />User Name(Login Id) : " & TxtLoginId.Text & _
    ...
    Private Sub BuildQuery()
        ...
        If strsql <> "" Then
            strsql = "select * from OtherAdminLogins where 1=1 " & strsql & " order by branch"
    ...
    Protected Sub GVAdmins_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVAdmins.RowCommand
        If e.CommandName = "CmdEdit" Then
            ...
            If Dt.Rows.Count > 0 Then
                ...
                LblOtherAdminID.Text = dtrow("OtherAdminId")
        ...
        If e.CommandName = "CmdResetPwd" Then
            ...
            If GVAdmins.Rows(e.CommandArgument).Cells(3).Text <> "&nbsp;" Then
                Message = "<font face='Verdana' size='2'>Dear " & GVAdmins.Rows(e.CommandArgument).Cells(1).Text & ", <br /><br />" & _
                        "<br /><br /></font>" & _
                        " You Password has been reset and following are the details to access the administrator control panel.<br /><br />" & _
                        "<br />URL '" & System.Configuration.ConfigurationManager.AppSettings("WebsiteURL") & "admin/'<br />" & _
                        "<br />User Name(Login Id) : " & GVAdmins.Rows(e.CommandArgument).Cells(0).Text & _
                        "<br />Password : " & Password & _
                        "<br /><br /><font face='Verdana' size='2'>Thanks & Regards,<br />" & _
                        "Website Support Team,<br />" & _
                        "KIMS Hospitals. </font>"
