...
Public Class _default9
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            DtDoc = DsDoc.GetAllActivedatabyId(Request("VENDORID"))
       ...
       Dim photoname As String = LblDocPhoto.Text
        If FUPhoto.HasFile Then
            ...
            Else
                ...
                FUPhoto.PostedFile.SaveAs(Server.MapPath("~/expertphotos") & "/" & Request("vendorid") & "_" & code & "." & Right(FUPhoto.PostedFile.FileName, 3))
                photoname = Request("vendorid") & "_" & code & "." & Right(FUPhoto.PostedFile.FileName, 3)
            End If
        End If
        ...
        caredoc.Updatevendoruserderailsinadminpannel(sp, TxtQualification.Text, Age.Text, Salutation.Text, Address.Text, "0", "0", ddlCountry.SelectedValue, Zip.Text, MobPh.Text, "Y", photoname, DoctorCode.Text, Txtbriefprofile.Value, Txtpresentposition.Value, TxtQualifications.Value, txtsepcialtraining.Value, txtexperience.Value, txtexpertise.Value, txtachievements.Value, txtpublications.Value, txtawardsandhonours.Value, txtacademicexposure.Value, txttalkdelivered.Value, txtothers.Value, txtmedia.Value, txtfirstname.Text, txtlastname.Text, EmailId.Text, branch, Request("VENDORID"))

        LblMsg.Text = "Expert -- [" & txtfirstName.Text & "] Updated Successfully"
        
        clear()

        Response.Redirect("~/Admin/NAdmin/Manage-Vendor/view-vendor/default.aspx")
