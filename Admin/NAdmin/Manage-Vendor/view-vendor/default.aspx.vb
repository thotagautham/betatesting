...
Public Class _default7
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            DDLSpecialisation.DataSource = DsSpec.GetData
            ...
            DDLBranch.DataTextField = "VENDORTYPENAME"
            DDLBranch.DataValueField = "VENDORTYPEID"
            DDLBranch.DataBind()
    ...
    Private Sub BuildQuery()
        ...
        strsql = "select * from VENDORSUsers  where 1=1"

        If Trim(TxtDoctorName.Text) <> "" Then
            strsql = strsql & " and Firstname like '%" & Trim(TxtDoctorName.Text) & "%'"
        End If

        If DDLBranch.SelectedIndex <> 0 Then
            strsql = strsql & " and vendortype  Like '%$" & DDLBranch.SelectedValue & "$%'"
        End If

        If DDLSpecialisation.SelectedIndex <> 0 Then
            strsql = strsql & " and VendorSPECIALISATION Like '%$" & DDLSpecialisation.SelectedItem.Value & "$%'"
        End If
