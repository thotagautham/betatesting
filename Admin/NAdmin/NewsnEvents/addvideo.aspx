<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminBasePage.master" CodeBehind="addvideo.aspx.vb" Inherits="KimsHospitals.addvideo" %>
     ...
     <div align="center">
        <table>
            ...
            <tr class="AlternateRowStyle">
                ...
                <td><asp:TextBox ID="txttargeturl" runat="server"  TextMode="MultiLine" Rows="4" Columns="50"></asp:TextBox>
                </td>
            </tr>
