<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminBasePage.master" CodeBehind="abstract-gcs.aspx.vb" Inherits="betatesting.abstract_gcs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <asp:GridView ID="GvBannerImages" runat="server" AllowPaging="True" 
                    AutoGenerateColumns="False" DataKeyNames="GCSQUERYID" CellPadding="10" AlternatingRowStyle-BorderStyle="Outset" PageSize="1000">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                ...
                                <a href='http://globalcancersummit.com/abstract/<%# Eval("currentstatus")%>'  target="_blank">View Abstract</a>
                         ...
                         <asp:BoundField DataField="GCSQUERYID" HeaderText="Id" 
                            SortExpression="GCSQUERYID" />
