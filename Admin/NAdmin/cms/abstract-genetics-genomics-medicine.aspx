<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminBasePage.master" CodeBehind="abstract-genetics-genomics-medicine.aspx.vb" Inherits="betatesting.abstract_genetics_genomics_medicine" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <asp:GridView ID="GvBannerImages" runat="server" AllowPaging="True" 
                    AutoGenerateColumns="False" DataKeyNames="geneticsgenomicsmedicineQUERYID" CellPadding="10" AlternatingRowStyle-BorderStyle="Outset" PageSize="1000">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                         ...
                         <asp:BoundField DataField="geneticsgenomicsmedicineQUERYID" HeaderText="Id" 
                            SortExpression="geneticsgenomicsmedicineQUERYID" />
