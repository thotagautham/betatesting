<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminBasePage.master" CodeBehind="abstract-gynacology.aspx.vb" Inherits="betatesting.abstract_gynacology" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <asp:GridView ID="GvBannerImages" runat="server" AllowPaging="True" 
                    AutoGenerateColumns="False" DataKeyNames="gynaabstractQUERYID" CellPadding="10" AlternatingRowStyle-BorderStyle="Outset" PageSize="1000">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField ShowHeader="False">
                            <ItemTemplate>
                                ...
                                <a href='http://gynecologyconference.org//abstract/<%# Eval("currentstatus")%>'  target="_blank">View Abstract</a>
                         ...
                         <asp:BoundField DataField="gynaabstractQUERYID" HeaderText="Id" 
                            SortExpression="gynaabstractQUERYID" />
