...
Public Class add_media
    ...
    Dim DsOhPrintMedia As New KfrcOHPrintMediaTableAdapter
    ...
    Protected Sub BtnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        '            ID = CStr(DsIdentity.GetCurrentIdentityByTableName("OHPrintMedia") + 1)
        '        End If
        ...
        '            pdfname = ConfigurationManager.AppSettings("WebsiteURL") & "newsandevents.aspx?archives=" & ID
        '        Else
    ...
    Protected Sub GVPrintNews_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVPrintNews.RowCommand
        If e.CommandName = "CmdEdit" Then
            ...
            If DtImages.Rows.Count > 0 Then
                ...
                txtpagedescription.Text = dtrow("pagedescription")
    ...
    Private Sub BuildQuery2()
        Dim strsql1 = "select distinct * from KfrcOHPrintMedia"
        strsql = ""
