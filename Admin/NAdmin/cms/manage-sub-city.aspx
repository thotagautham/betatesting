<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Admin/AdminBasePage.master" CodeBehind="manage-sub-city.aspx.vb" Inherits="betatesting.manage_sub_city" %>
     ...
     <tr class="RowStyle">
        ...
        <td class="tdStyle">
            <asp:DropDownList ID="ddlcity" runat="server" AppendDataBoundItems="True" 
                AutoPostBack="True">
                <asp:ListItem Value="0">-- Select Any city --</asp:ListItem>
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                ControlToValidate="DDLState" Display="None" 
                ErrorMessage="Enter City Name" ValidationGroup="VGSave" InitialValue="0"></asp:RequiredFieldValidator>
        </td>
    </tr>
