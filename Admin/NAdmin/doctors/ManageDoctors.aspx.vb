...
Partial Class Admin_Doctors_ManageDoctors
    ...
    Dim DsFirstBranch As New BRANCH1TableAdapter
    Dim DsSecondBranchTimmings As New BRANCH1TableAdapter
        ...
        If Not IsPostBack Then
            ...
            If DtDoc.Rows.Count > 0 Then
                ...
                If Not IsDBNull(dtrow("photo")) Then
                    If dtrow("photo") <> "no_img.jpg" Then
                ...
                If Not IsDBNull(dtrow("specialisation")) Then
                    spArr = Split(dtrow("specialisation").Replace("$", ""), ",")
                ...
                If Not IsDBNull(dtrow("department")) Then
                    deptArr = Split(dtrow("department").Replace("$", ""), ",")
                    For i = 0 To UBound(deptArr)
                        If Not LBDepartments.Items.FindByValue(deptArr(i)) Is Nothing Then
                            LBDepartments.Items.FindByValue(deptArr(i)).Selected = True
                        End If
                    Next
                End If

                If Not IsDBNull(dtrow("institutes")) Then
                    institutesArr = Split(dtrow("institutes").Replace("$", ""), ",")
                    For i = 0 To UBound(institutesArr)
                        If Not LBInstitutes.Items.FindByValue(institutesArr(i)) Is Nothing Then
                            LBInstitutes.Items.FindByValue(institutesArr(i)).Selected = True
                        End If
                    Next
                End If

                If Not IsDBNull(dtrow("Branch")) Then
                    branchArr = Split(dtrow("Branch").Replace("$", ""), ",")
                ...
                'If Not IsDBNull(dtrow("SecMondayTimmings")) Then
                '    SecMondayTimmings.Text = dtrow("SecMondayTimmings")
                'End If


                'If Not IsDBNull(dtrow("SecTuesdayTimmings")) Then
                '    SecTuesdayTimmings.Text = dtrow("SecTuesdayTimmings")
                'End If


                'If Not IsDBNull(dtrow("SecWednesdayTimmings")) Then
                '    SecWednesdayTimmings.Text = dtrow("SecWednesdayTimmings")
                'End If


                'If Not IsDBNull(dtrow("SecThursdayTimmings")) Then
                '    SecThursdayTimmings.Text = dtrow("SecThursdayTimmings")
                'End If

                'If Not IsDBNull(dtrow("SecFridayTimmings")) Then
                '    SecFridayTimmings.Text = dtrow("SecFridayTimmings")
                'End If


                'If Not IsDBNull(dtrow("SecSaturdayTimmings")) Then
                '    SecSaturdayTimmings.Text = dtrow("SecSaturdayTimmings")
                'End If


                'If Not IsDBNull(dtrow("SecSundayTimmings")) Then
                '    SecSundayTimmings.Text = dtrow("SecSundayTimmings")
                'End If
