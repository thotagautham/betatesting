<%@ Page Title="Manage Cities :: Administrator :: KIMS Hospitals" Language="VB" MasterPageFile="~/Admin/AdminBasePage.master" AutoEventWireup="false" Inherits="betatesting.Admin_NAdmin_Settings_ManageCity" Codebehind="ManageCity.aspx.vb" %>
