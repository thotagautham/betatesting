<%@ Page Title="Manage Country,State, Cities" Language="VB" MasterPageFile="../../AdminBasePage.master" AutoEventWireup="false" Inherits="betatesting.Admin_NAdmin_Settings_ManageCityStateCountry" Codebehind="ManageCityStateCountry.aspx.vb" %>
