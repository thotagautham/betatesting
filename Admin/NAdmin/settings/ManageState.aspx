<%@ Page Title="Manage State :: Administrator :: KIMS Hospitals" Language="VB" MasterPageFile="../../AdminBasePage.master" AutoEventWireup="false" Inherits="betatesting.Admin_NAdmin_Settings_ManageState" Codebehind="ManageState.aspx.vb" %>
