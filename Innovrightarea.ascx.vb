...
Public Class enquiry
    ...
    Dim DsAC As New DataSetCareTableAdapters.innovationASKCARETableAdapter
    ...
    Protected Sub ImgBtnSendEnquiry_Click(ByVal sender As Object, ByVal e As System.Web.UI.ImageClickEventArgs) Handles ImgBtnSendEnquiry.Click
        ...
        ElseIf TxtComments.Text = "" Then
            ...
            Exit Sub
        End If
        DsAC.Insert(TxtComments.Text, "0", "0", "1/1/1999", "0", "0", Now(), "1/1/1999", "Received", TxtName.Text, "N/A", "N/A", "0", "0", TxtEmailID.Text, TxtTelephone.Text, "0", "1/1/1999", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "")
        ...
        subject = "Enquiry -- Innovation in Healthcare Summit-2016"
