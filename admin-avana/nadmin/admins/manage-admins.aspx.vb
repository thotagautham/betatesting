...
Public Class manage_admins
    ...
    Dim DsAdmins As New avanaAdminLoginsTableAdapter
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            getData("select * from avanaAdminLogins order by avanaAdminLoginsId ")
            ...
            Else
                ...
                If TxtEmailId.Text <> "" Then
                    Message = "<font face='Verdana' size='2'>Dear " & TxtName.Text & ", <br /><br />" & _
                            "<br /><br /></font>" & _
                            " Welcome to Avana . Following are the details to access the administrator control panel.<br /><br />" & _
    ...
    Private Sub BuildQuery()
        ...
        If strsql <> "" Then
            strsql = "select * from avanaAdminLogins where 1=1 " & strsql & " order by avanaAdminLoginsId"
    ...
    Protected Sub GVAdmins_RowCommand(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewCommandEventArgs) Handles GVAdmins.RowCommand
        If e.CommandName = "CmdEdit" Then
            ...
            If Dt.Rows.Count > 0 Then
                ...
                LblOtherAdminID.Text = dtrow("avanaAdminLoginsId")
