...
Public Class manage_product_description1
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles BtnSave.Click
        ...
        If BtnSave.Text = "Update" Then
            ...
            dspdes.Update(TxtHproductslistdescriptionDESC.Text, "Y", Request("heteroid"), txthpdquantityperpack.Text, txthpdquantityperstrip.Text, txthpdratevalidform.Text, txthpdpricetoretailer.Text, txthpdmrp.Text, txthpdstandardrate.Text, txthpdpricetostockist.Text, txthpdbrandname.Text, ddlhdpcategoryname.SelectedItem.Value, CommonFunctions.GetListBoxSelectedItems(lbBranch), txthdpmanfacturename.Text, fileId.Text)
        Else
            dspdes.Insert(TxtHproductslistdescriptionDESC.Text, "Y", Request("heteroid"), txthpdquantityperpack.Text, txthpdquantityperstrip.Text, txthpdratevalidform.Text, txthpdpricetoretailer.Text, txthpdmrp.Text, txthpdstandardrate.Text, txthpdpricetostockist.Text, txthpdbrandname.Text, ddlhdpcategoryname.SelectedItem.Value, CommonFunctions.GetListBoxSelectedItems(lbBranch), txthdpmanfacturename.Text)
        End If
    ...
    Protected Sub GVAddVideo_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles GVAddVideo.RowCommand
        If e.CommandName = "CmdEdit" Then
            ...
            If Dtaddvideo.Rows.Count > 0 Then
                ...
                If Not IsDBNull(dtrow("HproductslistdescriptionDESC")) Then
                    TxtHproductslistdescriptionDESC.Text = dtrow("HproductslistdescriptionDESC")
                End If
