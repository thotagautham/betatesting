<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/admin-hhc/adminbasepage.master" CodeBehind="manage-product-description2.aspx.vb" Inherits="betatesting.manage_product_description" %>
     ...
     <div>
        ...
        <br/>
            ...
            <div>  
             ...
             <asp:RequiredFieldValidator ID="RequiredFieldValidator6" Display="None" runat="server" ControlToValidate="lbBranch" ValidationGroup="vgmanagecity" ErrorMessage="Select Any Zone"></asp:RequiredFieldValidator>
   
            <div>hdpmanfacturename</div>
            
            <div>
                 <asp:TextBox ID="txthdpmanfacturename" runat="server"></asp:TextBox>
                 <asp:RequiredFieldValidator ID="RequiredFieldValidator12" Display="None" runat="server" ControlToValidate="txthdpmanfacturename" ValidationGroup="vgmanagecity" ErrorMessage="Select Any Zone"></asp:RequiredFieldValidator>
            </div>
