<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="clinic-register.aspx.vb" Inherits="betatesting.clinic_register" %>
 ...
 <div class="container-fluid maincontent">
    <div class="container">
        ...
        <div class="col-sm-12 col-xs-12 col-md-6">
        	...
        	<p class="paragraph"><b>New User</b></p>
        </div>
...
<!-- social icons -->
    	 ...
    	 <div class="col-sm-12 col-xs-12 col-md-6">
        	 <div class="col-sm-12 col-xs-12 col-md-12">
        	<p class="paragraph"><b> Old Patient Login</b></p>
        </div>
        
        <div class="col-sm-12 col-xs-12 col-md-12">
        	<input type="Patient" class="form" placeholder="Patient id / Contact Number">
        </div>
