...
Public Class contactform
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        ElseIf TxtComments.Text = "" Then
            ...
            Exit Sub
        End If
        DsAC.Insert(TxtComments.Text, "General Enquiry", 0, 0, "1/1/1999", "", 0, Now(), "1/1/1999", "Received", TxtName.Text, "N/A", "N/A", "0", "0", TxtEmailID.Text, txtsubject.Text, "0", "1/1/1999", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "Global Cancer Summit Enquiry")
        ...
        message = "<font face='Verdana' size='2'>Dear " & TxtName.Text & ", <br /><br />" & _
                     ...
                     "<tr><td><font face='Verdana' size='2'>Subject #</td><td>:</td><td><font face='Verdana' size='2'>" & txtsubject.Text & "</font></td></tr>" & _
