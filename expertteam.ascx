<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="expertteam.ascx.vb" Inherits="betatesting.expertteam" %>
...
<HeaderTemplate><table width="600" border="0" cellspacing="0" cellpadding="0"></HeaderTemplate>
      ...
      <tr class="doctor_porfilestwo_border">
        ...
        <table ><tr valign="top">
                ...
                <tr>
                    <td colspan="2" align="left" ><span><asp:Label ID="LblDepartment" runat="server" Text='<%# Eval("VendorSPECIALISATION")%>' CssClass="specialtext2"></asp:Label></span>
            </td>
                    
                </tr>
               
                <tr>
                    <td colspan="2" valign="top" height="40"><asp:Label ID="LblBranch" runat="server" Text='<%# Eval("vendortype")%>' CssClass="htagtext"></asp:Label></td>
