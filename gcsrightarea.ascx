<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="gcsrightarea.ascx.vb" Inherits="betatesting.gcsrightare" %>
    ...
    <div>
        ...
        <asp:RequiredFieldValidator ID="RFVComments" runat="server" ControlToValidate="TxtComments" Display="None" ValidationGroup="VGEnquiry" ErrorMessage="Enter Comments" InitialValue="Type Message"></asp:RequiredFieldValidator>
                        ...
                        <div class="form-group">
                            <asp:ImageButton ID="ImgBtnSendEnquiry" runat="server" ImageUrl="gcs2016files/images/submit_img.png"  class="btn btn-danger enquirysubmit" ValidationGroup="VGEnquiry" />
...
<%--<div class="hommainrightnew2">
     ...
     <td style="padding: 4px;">
      ...
      <td style="padding: 4px;">
        ...
        <tr>
       <td style="margin-left:60px; padding:12px; padding:4px;" align="center">
          <asp:ImageButton ID="ImgBtnSendEnquiry" runat="server" ImageUrl="~/resources/images/ask-btn.jpg"  ValidationGroup="VGEnquiry" />
        <asp:ValidationSummary ID="ValidationSummary1" runat="server" ShowMessageBox="True" ShowSummary="False" ValidationGroup="VGEnquiry" />
        </td>
        </tr>
      </table>
