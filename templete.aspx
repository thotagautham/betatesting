<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="templete.aspx.vb" Inherits="betatesting.templete" %>
...
<table border=0 cellpadding=0 cellspacing=0>
   <tr class="GridRowStyle"><td colspan="2" class="GridHeaderStyle">Add Print Media News</td></tr>
    ...
    <tr class="AlternateRowStyle">
            ...
            <td>
             <FCKeditorV2:FCKeditor ID="txtheading" runat="server" Height="600" Width="900" EnableSourceXHTML="true">
