<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/innerbasepage.master" CodeBehind="edit-profile.aspx.vb" Inherits="betatesting.edit_profile" %>
...
<TBODY>
           ...
           <%-- <TR>
            ...
            <TR class="AlternateRowStyle">
                ...
                <TD><asp:TextBox id="txtcountry" runat="server" MaxLength="800" Rows="3" TextMode="MultiLine"></asp:TextBox></TD></TD>
